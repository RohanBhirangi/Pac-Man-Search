...
import pacman.entries.pacman.AStar;
import pacman.entries.pacman.BreadthFirst;
import pacman.entries.pacman.DepthFirst;
import pacman.entries.pacman.EvolutionStrategy;
import pacman.entries.pacman.GeneticAlgorithm;
import pacman.entries.pacman.HillClimbing;
import pacman.entries.pacman.IterativeDeepening;
import pacman.entries.pacman.MyPacMan;
import pacman.entries.pacman.SimulatedAnnealing;
...
//		exec.runGameTimed(new BreadthFirst(),new StarterGhosts(),visual);
//		exec.runGameTimed(new DepthFirst(),new StarterGhosts(),visual);
//		exec.runGameTimed(new IterativeDeepening(),new StarterGhosts(),visual);
//		exec.runGameTimed(new HillClimbing(),new StarterGhosts(),visual);
		exec.runGameTimed(new SimulatedAnnealing(),new StarterGhosts(),visual);
//		exec.runGameTimed(new AStar(),new StarterGhosts(),visual);
//		exec.runGameTimed(new EvolutionStrategy(),new StarterGhosts(),visual);
//		exec.runGameTimed(new GeneticAlgorithm(),new StarterGhosts(),visual);
